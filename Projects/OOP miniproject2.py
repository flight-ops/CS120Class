...
def student_actions():
    ...
    while loop == True:
        ...
        if student_action_request == "":
            student.student_search_teacher_by_name(my_school_system.teacher_list)
        elif student_action_request == "":
            student.student_search_teacher_by_course(my_school_system.teacher_list)
...
def teacher_actions():
    loop = True
    while loop == True:
        teacher_action_request = input("What would you like to do? options are view school log,\n")
        teacher_action_request = teacher_action_request.lower()
        if teacher_action_request == "":
            teacher.teacher_change_grade(my_school_system.student_list)
